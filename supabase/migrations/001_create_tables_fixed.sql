...
CREATE INDEX IF NOT EXISTS idx_brand_values_brand ON brand_values(brand_name);
CREATE INDEX IF NOT EXISTS idx_device_attributes_brand ON device_attributes(brand);
CREATE INDEX IF NOT EXISTS idx_device_attributes_device ON device_attributes(device_name);
